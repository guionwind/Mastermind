...
public class DriverRanquing {
    ...
    public void testAdd(){
        ...
        EstadistiquesPartida estadistica = new EstadistiquesPartida(jugador, null, 2300, 300);
    ...
    public void testGetTopN(){
        Ranquing test = new Ranquing();
        Jugador jugador = new Jugador("Pepe", "1234");
        EstadistiquesPartida estadistica = new EstadistiquesPartida(jugador, null, 5000, 300);
        test.add(estadistica);
        Jugador jugador_2 = new Jugador("Maria", "1234");
        EstadistiquesPartida estadistica_2 = new EstadistiquesPartida(jugador_2, null, 1000, 500);
        test.add(estadistica_2);
        Jugador jugador_3 = new Jugador("Antonio", "1234");
        EstadistiquesPartida estadistica_3 = new EstadistiquesPartida(jugador_3, null, 2300, 400);
